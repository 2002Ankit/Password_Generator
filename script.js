...
// fuction for getting random value
...
// how to copy password to clipboard...give confirmation..
...
generateBtn.addEventListener('click', () => {
    ...
    console.log("generate journey start");
    // remove old password....
    ...
    // shufffle the password.....
    password = shufflePassword(Array.from(password));
    console.log("shuffling done");
    // show in UI.....
    passwordDisplay.value = password;
    console.log("UI addition done");
    // calaculating strength......
    calcStength();
});
